-- ==========================================================
-- ECHORURA MUSICCHAIN Idempotent Payment Reconciliation System
...
CREATE POLICY "Users can insert their own pending purchases"
  ...
  TO authenticated
  -- Do not allow users to insert orders for other users
...
DROP FUNCTION IF EXISTS public.purchase_equity_on_chain(uuid, bigint, integer, text, text);
